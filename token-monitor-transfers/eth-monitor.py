...
infura = 'https://mainnet.infura.io/v3/8.......'
...
def transfer_token(private_key, from_account, to, amount):
    try:
        ...
        logging.info("tx_hash: %s", web3.to_hex(tx_hash))
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            logging.info(f"Current balance: {transfer_amount}")
